                ...
                <div class="grid grid-cols-1 lg:grid-cols-4 gap-8">
                    ...
                    <div class="mb-4 lg:mb-0">
                        <div class="Footer-contactDetails">
                            <h5 class="text-base font-black">Address</h5>
                            <div class="font-light">
                                <div class="AddressBlock">
                                    Room 303 &amp; 304 Stockport<br />
                            ...
                            <h5 class="text-base font-black">Phone</h5>
                            <div class="font-light">
                                <a class="PhoneNumber" href="tel:01513050770">0151 305 0770</a>
                            </div>
                        </div>
                    </div>
                    <div>
                        <div class="lg:mb-8">
                            <h4 class="font-medium text-xl">Office Opening Hours</h4>
                            <p class="font-light">09.00 - 17.00 Mon -Fri</p>
                        </div>
                        <div class="Footer-links">
                            <div class="Footer-listColumn">
                                <div class="Footer-listHeader">
                                    <h5 class="Footer-listHeading">Links</h5>
                                </div>
                                ...
                                <ul class="Footer-listLinks">
                                    ...
                                    <li class="Footer-listItem">
                                        <a href="#" target=""
                                        class="Footer-listText" title="Site Map">
                                            Site Map
                                        </a>
                                    </li>
                                </ul>
                    ...
                    <div>
                        <div class="Footer-logo lg:mb-8">
                            <svg fill="#fff" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 114 59">
        ...
        <div class="Footer-info py-8">
            <div class="Container">
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    <div>
                        <div class="Footer-copyright font-light text-sm">
                            &copy;2020 Right at Home UK, All Rights Reserved | Reg Name: Right at Home UK | Reg Number: 07064895 | Reg Country: England
                        </div>
                    </div>
                    <div>
                        <span class="font-light text-sm text-right">Right at Home National Site</span>
                    </div>
                </div>
            </div>
        </div>
